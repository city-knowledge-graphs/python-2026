...
if test=="world-cities":
    ...
    #PATH TO DATA
    path_to_data_file = "../lab6/solution/data/worldcities-free-100-task4stars.ttl"
    path_to_onto_file = "../lab6/data/ontology_worldcities.ttl"
    ...
    query_file="./data/query_nobel-prize2.txt"

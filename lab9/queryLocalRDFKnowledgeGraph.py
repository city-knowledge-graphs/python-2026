...
if test=="playground":
    ...
    #query="solution/query1_playground.txt"
    #query="solution/query2_playground.txt"
    #query="solution/query3_playground.txt"
    
elif test=="world-cities":
    #World-cities
    dataset = "./data/worldcities-free-100-task4stars.ttl"
    format_data = "ttl"
    ...
    #Solutions to be adeed
    #query = "solution/query4_world-cities.txt";
    ...
    #Solutions to be adeed    
    #query = "solution/query5_nobel-prize.txt";
    #query = "solution/query6_nobel-prize.txt";
